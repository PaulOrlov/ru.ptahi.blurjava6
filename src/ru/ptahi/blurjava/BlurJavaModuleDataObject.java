...
class MYLAYERUI extends LayerUI<java.awt.Container> {
    ...
    private IplImage pimg = cvLoadImage(currentDir + "/data/fonnew.jpg"),
                     pimg1 = cvLoadImage(currentDir + "/data/fonnew1.jpg"),
                     blackpoint = cvLoadImage(currentDir + "/data/blackpoint.jpg"),
                     srcImg, 
                     destImg;
